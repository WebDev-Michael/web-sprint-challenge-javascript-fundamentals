...
const zooAnimals = [
  ...
  */
  function animalNames(array){
    ...
    array.forEach(({animal_name, scientific_name}) => {
  ...
  */
  ...
  function lowerCaseNames(array){
    let newArray = array.map(({animal_name}) => animal_name.toLowerCase());
    return newArray;
  }
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    const filteredArray = zooAnimals.filter(obj =>
      obj.population < 5);
  ...
  */
  ...
  function USApop(array){
    const totalPop = array.reduce((total, zoo) => {
  ...
  */
  ...
  // console.log(consume(3,4));
  // console.log(consume('michael', 'wilcox'));
...
function greeting(firstName, lastName){
  const string = `Hello ${firstName} ${lastName}, nice to meet you!`
  return string;
  }
  
  console.log(greeting('Michael', 'Wilcox'));
